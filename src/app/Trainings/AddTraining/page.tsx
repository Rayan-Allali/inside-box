          ...
          <Form className="mt-16 py-6 pl-12 grid grid-rows-6 grid-cols-[50%_40%] gap-y-4 font-gilroy font-light bg-gray-light bg-opacity-10 rounded-md">
            ...
            <Popup
              trigger={
                <label htmlFor="" className="row-start-6 col-start-1">
                  ...
                  <button
                    type="button"
                    className="relative w-2/3 p-2.5 m-2 cursor-pointer text-start border-gray-400  bg-blue-primary disabled:bg-opacity-100 border text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block"
                  >
                    List of students
                    <div className="absolute inset-y-0 right-0 flex items-center pointer-events-none pr-4">
                      ...
                      >
                        <g clip-path="url(#clip0_51_798)">
                          <path
                            d="M2.02002 11.3859L7.55227 6.32625L2.02002 1.2666"
                            stroke="white"
                            stroke-width="1.30105"
                        ...
                        <defs>
                          <clipPath id="clip0_51_798">
                            <rect
                              ...
                              height="13"
                              fill="white"
                              transform="matrix(-1 0 0 -1 8.38477 13)"
                            />
                          </clipPath>
                        </defs>
                      </svg>
            ...
            >
              ...
              <Field
                ...
                className="w-[300px] p-2 border-2 border-gray-400 rounded-md"
              />
              <ErrorMessage
                name="description"
                component="div"
