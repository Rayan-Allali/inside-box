    ...
    <div className='py-20 h-full flex justify-between'>
       ...
       <div className="flex justify-between w-full mb-10">
        ...
        <div className='w-full flex justify-end'>
                    <button className='mt-8 text-[#07A2F3] items-center text-xl font-bold  border-[2px] border-[#07A2F3] flex justify-around min-w-[200px] px-[20px] py-[14px] rounded-md'>View Assignments</button>
        </div>
        </div>
