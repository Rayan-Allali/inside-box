...
import Adult from "@/assets/images/Student/Adult.png"
            ...
            <div className=' w-[1450px] flex justify-center items-start mt-[80px]'>
                <div className='flex flex-col gap-[88px]'>
                    <div className='flex flex-col gap-[32px]'>
                        <h1 className='text-[56px] font-bold w-[934px] font-Bold'>Welcome To <span className='text-[#07A2F3]'>InsideBox</span> the best place to boost your Skills !</h1>
                        <p className='w-[803px] font-light text-[32px] text-[#808080]'>Le lorem ipsum est, en imprimerie, une suite de mots sans signification utilisée à titre provisoire pour calibrer une mise en page</p>
                    </div>
                    <button className='bg-[#38CFBA] w-[348px] font-extrabold text-white text-[28px] h-[100px] rounded-[8px]'>
                        Discover More
                    </button>
                </div>
                <Image alt="AdultGeneral" src={Adult} />
            </div>
