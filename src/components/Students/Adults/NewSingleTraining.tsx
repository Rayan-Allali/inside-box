...
import Webimg from "@/assets/images/shared/WebCover.png"
...
export const NewSingleTraining=()=>{
    ...
    <div className='py-20 h-full flex justify-between'>
       ...
       <div className="flex justify-between w-full mb-10">
        ...
        <p className='text-[#676C72] text-[24px] font-light py-[4%]'>{training.desc}</p>
...
export default NewSingleTraining