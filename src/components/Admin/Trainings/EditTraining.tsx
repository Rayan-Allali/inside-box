    ...
    return (
        <AdminLayout>
            <div className='h-full pt-8 px-16'>
                <Header title='Edit a training' subtitle='You can control accounts of trainings !' />
                <Formik
                    ...
                    {({isSubmitting}) => (
                        <Form className='mt-16 py-6 pl-12 grid grid-rows-6 grid-cols-[50%_40%] gap-y-4 font-gilroy font-light bg-gray-light bg-opacity-10 rounded-md'>
                            ...
                            <label htmlFor="" className='row-start-6 col-start-1'>
                                <Field as="select" name="students" className='w-1/2 p-2 m-2 border-2 border-gray-400 rounded-md'>
                                    <option value="course">List of students</option>
                                    <option value="course1">Course 1</option>
                                    <option value="course2">Course 2</option>
                                    <option value="course3">Course 3</option>
                                </Field>
                                <ErrorMessage name="students" component="div" className='text-red-400'/>
                            </label>
