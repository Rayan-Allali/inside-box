...
const AddTrainer = () => {
    ...
    return (
        <div className='h-full pt-8 px-16'>
            <Header title='Edit a trainer' subtitle='You can control accounts of tainees!'/>
            <Formik
                ...
                {({isSubmitting}) => (
                    <Form className='mt-16 py-6 pl-12 grid grid-rows-4 grid-cols-[50%_40%] gap-y-4 font-gilroy font-light bg-gray-light bg-opacity-10 rounded-md'>
                        ...
                        <label htmlFor="">
                            ...
                            <Field type="text" name="firstName" placeholder="First Name" className='w-1/2 p-2 m-2 border-2 text-blue-text border-gray-400 rounded-md'/>
                        ...
                        <label htmlFor="" className='col-start-1'>
                            ...
                            <Field type="text" name="lastName" placeholder="Last Name" className='w-1/2 p-2 m-2 border-2 text-blue-text border-gray-400 rounded-md'/>
                        ...
                        <label htmlFor="" className='row-start-1 col-start-2'>
                            ...
                            <Field type="email" name="email" placeholder="Email" className='w-[60%] p-2 m-2 border-2 text-blue-text border-gray-400 rounded-md'/>
                        ...
                        <label htmlFor="">
                            ...
                            <Field type={viewPassword ? "text" : "password"} name="password" placeholder="Password" className='w-[60%] p-2 m-2 border-2 text-blue-text border-gray-400 rounded-md'/>
                        ...
                        <label htmlFor="" className='w-full col-start-1'>
                            ...
                            <Field as="select" name="trainingCourse" className='w-1/2 p-2 m-2 border-2 border-gray-400 rounded-md'>
                                <option value="course1" className='text-blue-text'>Course 1</option>
                                <option value="course2" className='text-blue-text'>Course 2</option>
                                <option value="course3" className='text-blue-text'>Course 3</option>
                            </Field>
                        </label>
