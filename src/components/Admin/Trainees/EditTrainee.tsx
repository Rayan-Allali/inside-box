    ...
    return (
        <AdminLayout>
            <div className='h-full pt-8 px-16'>
                <Header title='Edit a trainee' subtitle='You can control accounts of trainees !' />
                <Formik
                    ...
                    {({isSubmitting}) => (
                        <Form className='mt-16 py-6 pl-12 grid grid-rows-7 grid-cols-[50%_40%] gap-y-4 font-gilroy font-light bg-gray-light bg-opacity-10 rounded-md'>
                            ...
                            <label htmlFor="" className='w-full col-start-1'>
                                ...
                                <Field type="number" name="age" placeholder="Age" className='w-1/2 p-2 m-2 border-2 border-gray-400 rounded-md'/>
                            </label>

                            {/* Address */}
                            <label htmlFor="" className='w-full col-start-1'>
                                Address <span className='text-red-600 mr-16'>*</span>
                                <Field type="text" name="address" placeholder="Address" className='w-1/2 p-2 m-2 border-2 border-gray-400 rounded-md'/>
                            </label>

                            {/* Phone Number */}
                            <label htmlFor="" className='w-full col-start-1'>
                                Phone Number <span className='text-red-600 mr-4'>*</span>
                                <Field type="text" name="phoneNumber" placeholder="Phone Number" className='w-1/2 p-2 m-2 border-2 border-gray-400 rounded-md'/>
                            </label>

                            {/* Parent Number */}
                            <label htmlFor="" className='w-full col-start-1'>
                                Parent Number <span className='text-red-600 mr-4'>*</span>
                                <Field type="text" name="parentNumber" placeholder="Parent Number" className='w-1/2 p-2 m-2 border-2 border-gray-400 rounded-md'/>
                            </label>
