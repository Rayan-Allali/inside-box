...
const AssignmentContainer = (props: ICardContainerProps) => {
  ...
  return (
    ...
    {
        (Status=="Submited") ? <button type='button' className='border-2 rounded-b-[8px] border-[#38CFBA] w-[100%] text-[#38CFBA] font-medium py-[5%]'>
            Submited
        </button> : <button type='button' className='border-2 rounded-b-[8px] border-[#38CFBA] bg-[#38CFBA] w-[100%] text-white font-medium py-[5%]'>Submit Assignment</button>
    }
    </div>
  )
}
