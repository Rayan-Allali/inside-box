  ...
  return (
    <div className="h-full pt-8 px-20 flex flex-col space-y-10">
      <div className="text-primary-black font-gilroy">
        <h1 className="text-[44px] font-extrabold leading-normal">
          {" "}
          Discorver The Trainings We have !{" "}
        </h1>
      </div>
      ...
      <div className="flex flex-row justify-between ">
        ...
        />
        <button className="py-3 px-9 rounded-[8px] border-[#07A2F3] text-[#07A2F3] border-2">
          {" "}
          Filter{" "}
        </button>
      </div>
