  ...
  return (
    <div className="h-screen pt-8 px-20 flex flex-col space-y-10">
      ...
      <div className="flex flex-row justify-start space-x-7 ">
        ...
        <button className="py-4 px-9 rounded-[8px] text-[26px] border-[#38CFBA] text-[#38CFBA] border-2">
          {" "}
          Ch2 : Intro to web{" "}
        </button>
        <button className="py-4 px-9 rounded-[8px] text-[26px] border-[#38CFBA] text-[#38CFBA] border-2">
      ...
      <div className="bg-[#FBFBFB] h-[60%] flex flex-col justify-between space-y-10 px-10 py-5 ">
        ...
        <div className="flex flex-row-reverse items-center gap-5 ">
          <button className="py-3 px-7 rounded-[8px] text-[26px] bg-[#07A2F3] text-white border-2">
            Chat with your classmates{" "}
          </button>
          <button className="py-3 px-7 rounded-[8px] text-[26px] bg-[#896DDB] text-white border-2">
            View Assignements
          </button>
        </div>
      </div>
