    ...
    return (
     ...
     <div className='h-screen pt-8 px-20 flex flex-col space-y-14 font-gilroy'>
      <div className='flex flex-row justify-between'>
       <Header title='Thank You for enrolling this Course, One Step left' subtitle='Fill the test to define your starting point' />
        <button className='py-4 px-9 rounded-[8px] text-[26px] bg-[#38CFBA] text-white border-2'> Submit</button>
      </div>
       
    
       { Questions.map((Q) =>
           (  <div key={Q.id} className='flex flex-col justify-start space-y-4 '>
              <h1 className='text-2xl font-medium '> Q{Q.id}\ {Q.Qst} </h1>
