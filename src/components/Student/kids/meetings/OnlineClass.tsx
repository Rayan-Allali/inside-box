...
import Razane from '@/assets/images/shared/razane.png'
import Ayoub from '@/assets/images/shared/ayoub.png'
import Karim from '@/assets/images/shared/karim.png'
import Rayan from '@/assets/images/shared/rayan.png'
import Ryad from '@/assets/images/shared/ryad.png'
...
<div className='p-[40px] flex flex-col gap-[80px]'>
         <div className='flex justify-between items-center '  >
             <div className="flex flex-col gap-[10px] ">
                <h1 className="text-4xl font-bold max-w-[780px]">Welcome to the online class</h1>             
             </div>
