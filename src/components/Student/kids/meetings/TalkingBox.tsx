...
import phone from "@/assets/images/shared/round-call.svg";
import mic from "@/assets/images/shared/ic_baseline-mic.svg";
const TalkingBox = () => {
  return (
   ...
   max-w-[214px]
   text-[20px] flex
   items-center text-[#07A2F3]"
              >
                Front-End Development Training
              </h1>
              <h1 className=" font-bold max-w-[214px] text-[12px] flex items-center text-[#07A2F3]">
                Trainer: <span className="font-[400]"> Allali Rayan</span>
              </h1>
              <h1
   ...
   items-center text-[#07A2F3]"
              >
                Trainer: <span className="font-[400]"> 2h</span>
              </h1>
            </div>
